...
def _ddg_search(query: str, max_results: int) -> list[dict]:
    ...
    # Fallback to custom lite.duckduckgo.com scraping using httpx and BeautifulSoup
    try:
        import httpx
        ...
        resp = httpx.post("https://lite.duckduckgo.com/lite/", data={"q": query}, headers=headers, timeout=15)
